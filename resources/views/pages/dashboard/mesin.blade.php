                    ...
                    <form class="forminputdata space-y-6" action="{{ route('mesin.store') }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="click_price" id="click_price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pl-8" required inputmode="numeric">
                            </div>
                            @error('click_price')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                            @enderror
